...
<code>&lt;Manga Search&gt;</code>
</p>
<p>Manga search api</p>
...
<p class="card-description">
Please enter the name of the manga you want to search for
</p>
<form onsubmit="$('#loading').show();">
<div class="form-group">
<div class="input-group">
<input type="text" name="search" class="form-control" placeholder="Search manga..." aria-label="Search manga..." required="">
...
if (isset($_GET['search'])) {
    ...
    $mal = new \MyAnimeList\Search\Manga($search);
